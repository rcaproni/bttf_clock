...
#define I2C_READ 1
#define I2C_WRITE 0
#define DELAY 40 // usec delay
#define BUFFER_LENGTH 32
#define I2C_MAXWAIT 5000

class mySlowSoftI2CMaster {
 public:
  mySlowSoftI2CMaster(uint8_t sda, uint8_t scl);
  mySlowSoftI2CMaster(uint8_t sda, uint8_t scl, bool internal_pullup);
  bool i2c_init(void);
  ...
  bool i2c_write_lsb(uint8_t value);

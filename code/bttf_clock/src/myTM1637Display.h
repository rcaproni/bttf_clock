...
class myTM1637Display {

public:
  //! Initialize a myTM1637Display object, setting the clock and
  //! data pins.
  //!
  ...
  myTM1637Display(uint8_t pinClk, uint8_t pinDIO, unsigned int bitDelay = DEFAULT_BIT_DELAY);
  ...
  // using i2xc library
  void setSegments_i2c(const uint8_t segments[], uint8_t length = 4, uint8_t pos = 0);
